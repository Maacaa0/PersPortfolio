...
const Skills = () => {
  ...
  return (
    <article className="skills_article">
            ...
            <div className="svg_wrapper">
                {lightBulbIcon}
                <p className="text"> I have learned <span className="highlight">HTML</span>, <span className="highlight">CSS</span> and <span className="highlight">Javascript</span> essentials. Now I am on a path to learn React with Typescript and Git to take my skills to the next level. <br /> <br />
